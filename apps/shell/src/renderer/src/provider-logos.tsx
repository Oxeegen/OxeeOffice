...
// OxeeOffice brand hook: Oxeegen shows the app icon (swapped to the brand icon at build)
...
const LOGOS: Record<AiProviderId, ReactNode> = {
  // OxeeOffice brand hook: full-colour brand icon, fine in both themes
  oxeegen: (
    <img
      src={appIcon}
      alt=""
      aria-hidden="true"
      style={{ width: '1em', height: '1em', display: 'block', objectFit: 'contain', borderRadius: 3 }}
    />
  ),
  genspark: (
